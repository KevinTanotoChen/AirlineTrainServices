    ...
    <div class="box-content rounded-xl bg-white bg-opacity-50 border mt-10 mb-10 p-4 h-[440px] w-[280px] shadow-md hover:shadow-lg">
        <form action="/login" method="POST" class="grid grid-cols-1 justify-items-center">
            ...
            <div class="flex justify-center">
                ...
                <input type="text" name="email" id="email" placeholder="Email address" class=" h-8 w-48 p-2 mb-2 bg-[#D9D9D9] text-[12px] placeholder:text-[12px]" value="{{ old('email') }}" required autofocus>
            </div>
            <div class="flex justify-center">
                <div class="bg-[#444444] w-8 h-8 flex justify-center items-center">
