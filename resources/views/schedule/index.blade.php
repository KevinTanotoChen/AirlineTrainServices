...
@section('container')
    ...
    <div class="flex flex-col">
            ...
            <div class="relative title">
                ...
                <div class="absolute inset-0 flex justify-start items-center text-white p-20">
                    <div class="flex flex-col">
                        ...
                        <div class="flex-1">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa exercitationem illum minus
                                cupiditate.</p>
                        </div>
                ...
                <table class="table-fixed w-11/12 border-collapse border">
                    ...
                    <tbody class="text-center">
                        ...
                        <tr>
                            <td>
                                <ul>
                                    @foreach ($schedules_ordered_lr as $item)
                                        @if ($item->origin_station_id === 1)
                                            <li>{{ $item->departure_time }}</li>
                                        @endif
                                    @endforeach
                                </ul>
                            </td>
                ...
                <table class="table-fixed w-11/12 border-collapse border">
                    ...
                    <tbody class="text-center">
                        ...
                        <tr>
                            {{-- <td>
                                <ul>
                                    @foreach ($schedules_ordered_rl as $item)
                                        @if ($item->origin_station_id === 1)
                                            <li>{{ $item->departure_time }}</li>
                                        @endif
                                    @endforeach
        ...
        {{-- <div>
            @foreach ($schedules_ordered_rl as $schedule_order)
                <p>{{ $schedule_order }}</p>
            @endforeach
        </div> --}}
    </div>
