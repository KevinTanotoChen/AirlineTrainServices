    ...
    <div class="container mx-auto mt-10">
        <div class="w-full max-w-lg">
            <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <div class="card-header font-bold text-xl mb-6">{{ __('Create News Event') }}</div>
                <form method="POST" action="{{ route('news-event.store') }}" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <label for="excerpt" class="block text-gray-700 font-bold mb-2">{{ __('Excerpt') }}</label>
                        <textarea id="excerpt" class="form-control @error('excerpt') is-invalid @enderror" name="excerpt" rows="6" required style="border: 1px solid #000000;"></textarea>
