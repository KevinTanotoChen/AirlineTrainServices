            ...
            <div class="flex mt-10 mx-20 space-x-6">
                ...
                <div class="flex-1">
                    <div class="carousel">
                        ...
                        <div class="container">
                            <div class="box-content rounded-xl bg-white p-4 h-56 flex border shadow-md hover:shadow-lg">
                                <div class="owl-carousel promo-carousel owl-theme">
                                    @foreach ($promos as $promo)
                                        <a href="{{ route('promo.show', $promo->id) }}">
                                            <div class="item">
                                                <img src="{{ asset('storage/' . $promo->image) }}" alt="img">
                                            </div>
                                        </a>
                                    @endforeach
                                </div>
